                            ...
                            <div className="flex items-center gap-3">
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="text-sm px-4 py-1.5 uppercase bg-white hover:bg-white/90 transition-colors duration-150"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                                    <Link
                                        href={route('login')}
                                        className="text-sm px-4 py-1.5 bg-white uppercase hover:bg-white/90 transition-colors duration-150"
                                    >
                                        Log in
                                    </Link>
                                )}
                ...
                <div className="fixed bottom-0 w-full" style={{ height: `${FOOTER_HEIGHT}px` }}>
                    <footer className="relative h-full w-full overflow-hidden">
                        ...
                        <div className="relative z-[99] flex h-full flex-col justify-between text-white pl-10 pt-10 pb-8 pr-10">
                            ...
                            <div className="flex flex-col items-end gap-3 mb-2 mr-8">
