...
import { CheckCircle, Circle, Clock, Calendar, XCircle } from 'lucide-react';
...
export default function ApplicationTracking({
    ...
    const getProcessSteps = (): ProcessStep[] => {
        ...
        const baseSteps: ProcessStep[] = [
            {
                ...
                date: formatDate(selectedApp.applied_at),
                extra: null
            }
        ];
            ...
            baseSteps.push({
                ...
                extra: selectedApp.interview_date ? (
                    <div className="mt-1.5 p-2.5 bg-blue-50 border border-blue-200 rounded-lg inline-flex items-center gap-2 text-xs text-blue-900 font-medium">
                        ...
                        <span>
                            Scheduled: <strong>{formatDate(selectedApp.interview_date)}</strong>
                        </span>
                    </div>
                ) : (
        ...
        const isApproved = selectedApp.status_label === 'Recruited';
        const isRejected = selectedApp.status_label === 'Declined';
    ...
    return (
        <div className="p-6">
            <h1 className="text-3xl font-bold font-sato mb-6">
                                ...
                                <>
                                    ...
                                    <div className="space-y-6">
                                        {processSteps.map((step, idx) => {
                                            ...
                                            const isRejected =
                                                selectedApp.status_label === 'Declined' &&
                                                step.key === 'finalized';
                                        ...
                                        >
                                            <div className="text-left">
                                                ...
                                                <div className="text-xs text-muted-foreground">
                                                    {app.quota?.job_title ?? 'No Position'}
                                                </div>
                                            </div>
                                        </Button>
                                    </li>
...
ApplicationTracking.layout = (page: ReactNode) => (
